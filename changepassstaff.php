...
<div class="login">
  ...
  <h2 class="login-header">Staff Change Password</h2>

  <form action="upassstaff.php" method="post" class="login-container">
    <p><input type="text" name="u" placeholder="Username"></p>
    <p><input type="password" name="op" placeholder="Old Password"></p>
    <p><input type="password" name="np" placeholder="New Password"></p>

    <p><input type="submit" name="login" value="Change Password"></p>
  </form>
</div>
