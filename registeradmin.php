...
<div class="login">
  ...
  <h2 class="login-header">Admin Register</h2>

  <form action="insertregisteradmin.php" method="post" class="login-container">
    <p><input type="text" name="u" placeholder="Username"></p>
    <p><input type="password" name="p" placeholder="Password"></p>
    <p><input type="text" name="adn" placeholder="Admin Name"></p>
    <p><input type="text" name="add" placeholder="Address"></p>
    <p><input type="text" name="adph" placeholder="Phone Number"></p>
