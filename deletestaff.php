...
<div class="login">
  ...
  <h2 class="login-header">Delete Staff</h2>

  <form action="deles.php" method="post" class="login-container">
    <p><input type="text" name="u" placeholder="Staff Number"></p>
    <p><input type="password" name="p" placeholder="Password"></p>
    <p><input type="submit" name="Login1" value="Delete"></p>
  </form>
</div>
